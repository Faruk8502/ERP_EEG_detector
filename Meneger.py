...
if (Mode == 0):
    ...
    n_channels = 8
    n_filters = 8
    model = Train.CNN_2(input_reports, scales_reports, activation, dropout_rate, n_channels, n_filters)
    model.summary()
    # _____ Обучаем модель _____
    Epoch = 300
    Batch = 1024
    ...
    X_train_pd, X_test_pd = \
        Preparation.Processing(N_train, N_test, X_train, X_test)
    Test.Test(X_train_pd, y_train, X_test_pd, y_test, trs_test, sbj_test)