...
def CNN(data, pred, Fs):
    ...
    input = tf.keras.Input(shape=(128, 8, 1))
    C1 = layers.Conv2D(65, (64, 1), activation='relu')(input)
    C2 = layers.Conv2D(33, (32, 1), activation='relu')(input)
    C3 = layers.Conv2D(17, (16, 1), activation='relu')(input)
    D1 = layers.Conv2D(8, (1, 8), activation='relu')(C1)
    D2 = layers.Conv2D(8, (1, 8), activation='relu')(C2)
    D3 = layers.Conv2D(8, (1, 8), activation='relu')(C3)
    N1 = layers.Concatenate(axis=1)([D1, D2, D3])
    A1 = layers.AveragePooling2D(pool_size=(4, 1))(N1)
    C4 = layers.Conv2D(17, (16, 1), activation='relu')(A1)
    C5 = layers.Conv2D(9, (8, 1), activation='relu')(A1)
    C6 = layers.Conv2D(5, (4, 1), activation='relu')(A1)
    D4 = layers.Conv2D(8, (1, 1), activation='relu')(C4)
    D5 = layers.Conv2D(8, (1, 1), activation='relu')(C5)
    D6 = layers.Conv2D(8, (1, 1), activation='relu')(C6)
    N2 = layers.Concatenate(axis=1)([D4, D5, D6])
    A2 = layers.AveragePooling2D(pool_size=(2, 1))(N2)
    C7 = layers.Conv2D(9, (8, 1), activation='relu')(A2)
    A3 = layers.AveragePooling2D(pool_size=(2, 1))(C7)
    C8 = layers.Conv2D(5, (4, 1), activation='relu')(A3)
